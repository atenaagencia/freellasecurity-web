...
Route::post('submit-candidate-card', 'Job\JobPublishController@postcandidatecard_details')->name('post.candidate.card');
Route::get('add-paypal-customer/{milestoneId}', 'Job\JobPublishController@addpaypalcustomerform')->name('add.paypalcustomer.form');
Route::get('credit-payment-to-candidate/{milestoneId}', 'Job\JobPublishController@creditpayment')->name('credit.payment');
