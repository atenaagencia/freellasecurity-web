    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #292828; !important">
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?php echo e(route('my.profile')); ?>" data-toggle="collapse" data-target="#collapseTwo"
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?php echo e(route('view.public.profile', Auth::user()->id)); ?>" data-toggle="collapse" data-target="#collapseUtilities"
