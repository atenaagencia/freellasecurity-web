...
<?php echo $__env->make('includes.inner_page_title', ['page_title'=>__('Job Seekers')], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
...
<div class="listpgWraper">
    <div class="container">
        ...
        <form action="<?php echo e(route('job.seeker.list')); ?>" method="get">
            ...
            <div class="row"> <?php echo $__env->make('includes.job_seeker_list_side_bar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
