...
<!-- <?php echo $__env->make('includes.inner_page_title', ['page_title'=>__('Status de Desenvolvimento')], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> -->
<?php $__env->startSection('title-page'); ?>
<h1 class="h3 py-4 font-weight-bold text-dark"><?php echo e(__('Status de Desenvolvimento')); ?></h1>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-header bg-white rounded-0 py-3">
                <h6 class="m-0 font-weight-bold text-dark"><?php echo e(__('Status de Desenvolvimento')); ?></h6>
            </div>
            <!-- Card Body -->
