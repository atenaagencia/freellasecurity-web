...
<h1 class="h3 py-4 font-weight-bold text-dark"><?php echo e(__('Job Details')); ?></h1>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-body bg-white rounded-0">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'title'); ?>">
                            <label for="" class="text-dark font-weight-bold">Insert a Title Description</label>
                            <?php echo Form::text('title', null, array('class'=>'form-control', 'id'=>'title', 'placeholder'=>__('Job title'))); ?>
                    ...
                    <div class="col-md-12 py-3">
                        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'description'); ?>">
                            <label for="" class="text-dark font-weight-bold">Insert an Description</label>
                            <?php echo Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>__('Job description'))); ?>
                    ...
                    <div class="col-md-12 py-3">
                        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'skills'); ?>">
                            <label for="" class="text-dark font-weight-bold">Select the required skills:</label>
                    ...
                    <div class="col-md-12 py-3">
                        <div class="formrow <?php echo APFrmErrHelp::hasError($errors, 'country_id'); ?>" id="country_id_div">
                            <label for="" class="text-dark font-weight-bold">Select the country:</label>
                            <?php echo Form::select('country_id', ['' => __('Select Country')]+$countries, old('country_id', (isset($job))? $job->country_id:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')); ?>
                    ...
                    <div class="col-md-12 py-3">
                        <h4 class="font-weight-bold text-dark">Details of the Job</h4>
                    </div>
                    ...
                    <div class="col-md-6 py-3" style="display:none;">
                ...
                <script type="text/javascript">
                    ...
                    function filterLangStates(state_id) {
                        ...
                        if (country_id != '') {
                            $.post("<?php echo e(route('filter.lang.states.dropdown')); ?>", {
                    ...
                    function filterLangCities(city_id) {
                        ...
                        if (state_id != '') {
                            $.post("<?php echo e(route('filter.lang.cities.dropdown')); ?>", {
                                    state_id: state_id,
                                    city_id: city_id,
                                    _method: 'POST',
                                    _token: '<?php echo e(csrf_token()); ?>'
