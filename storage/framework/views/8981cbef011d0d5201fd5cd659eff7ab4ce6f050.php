...
<header class="masthead">
    <div class="container">
        ...
        <a class="btn btn-primary btn-xl text-uppercase mt-3" href="<?php echo e(route('login')); ?>">Publicar um trabalho</a>
    </div>
    </div>
</header>
...
<!-- Feature Jobs-->
<section class="page-section border-top" id="how" style="padding-bottom: 20px; background-color: #3693fe">
    <div class="container" >
        <div class="text-left py-3">
