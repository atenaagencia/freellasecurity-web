...
<h1 class="h3 py-4 font-weight-bold text-dark"><?php echo e(__('Company Followers')); ?></h1>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-header bg-white rounded-0 py-3">
                <h6 class="m-0 font-weight-bold text-dark"><?php echo e(__('Company Followers')); ?></h6>
            </div>
            <!-- Card Body -->
