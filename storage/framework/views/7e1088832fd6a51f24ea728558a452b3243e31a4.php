        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="userccount">
                    <div class="formpanel"> <?php echo Form::open(array('method' => 'post', 'route' => ['job.milestone.update', $job])); ?> 
                        <!-- Job Information -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="freelancer" id="freelancer">
                                    ...
                                    ?>
                                    <?php if(null !== $user): ?>
                                        <?php if($user->id==$editDetails[0]->candidate_id): ?> 
                                            <option selected="selected" value="<?php echo e($user->id); ?>"><?php echo e($user->getName()); ?></option>
                                        <?php else: ?>
                            ...
                            <div class="col-md-12">
                                <div class="formrow<?php echo e($errors->has('task_details') ? ' has-error' : ''); ?>">
                                    <textarea class="form-control" name="task_details" placeholder="Enter Details of task"><?php echo e($editDetails[0]->description); ?></textarea>
                                     <?php if($errors->has('task_details')): ?> <span class="help-block"> <strong><?php echo e($errors->first('task_details')); ?></strong> </span> <?php endif; ?>
                                </div>
                            </div>
                            <input type="hidden" name="editdetailId" value="<?php echo e($editDetails[0]->id); ?>">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                              <div class="formrowformrow<?php echo e($errors->has('start_date') ? ' has-error' : ''); ?>">
                                <div class='input-group date' id='startdate'>
                                    <input type='text' value="<?php echo e(date_format(date_create($editDetails[0]->start_date), 'm/d/Y')); ?>" class="form-control" name="start_date" placeholder="Start date" />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class='input-group date' id='enddate'>
                                    <input type='text' class="form-control" name="end_date" value="<?php echo e(date_format(date_create($editDetails[0]->end_date), 'm/d/Y')); ?>" placeholder="End date" />
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                        ...
                        <br>
                        <input type="submit" class="btn" value="<?php echo e(__('Update Milestone')); ?>">
