<div class="modal-body">
    <div class="form-body">
        <div class="formrow" id="div_title">
            <input class="form-control" id="title" placeholder="<?php echo e(__('Experience Title')); ?>" name="title" type="text" value="<?php echo e((isset($profileExperience)? $profileExperience->title:'')); ?>">
            <span class="help-block title-error"></span> </div>

        <div class="formrow" id="div_company">
            <input class="form-control" id="company" placeholder="<?php echo e(__('Company')); ?>" name="company" type="text" value="<?php echo e((isset($profileExperience)? $profileExperience->company:'')); ?>">
        ...
        <div class="formrow" id="div_state_id">
            <span id="default_state_experience_dd">
                <?php echo Form::select('state_id', [''=>__('Select State')], null, array('class'=>'form-control', 'id'=>'experience_state_id')); ?>
        ...
        <div class="formrow" id="div_date_start">
            <input class="form-control datepicker"  autocomplete="off" id="date_start" placeholder="<?php echo e(__('Experience Start Date')); ?>" name="date_start" type="text" value="<?php echo e((isset($profileExperience)? $profileExperience->date_start->format('Y-m-d'):'')); ?>">
            <span class="help-block date_start-error"></span> </div>
        <div class="formrow" id="div_date_end">
            <input class="form-control datepicker" autocomplete="off" id="date_end" placeholder="<?php echo e(__('Experience End Date')); ?>" name="date_end" type="text" value="<?php echo e((isset($profileExperience)? $profileExperience->date_end->format('Y-m-d'):'')); ?>">
        ...
        <div class="formrow" id="div_description">
            <textarea name="description" class="form-control" id="description" placeholder="<?php echo e(__('Experience description')); ?>"><?php echo e((isset($profileExperience)? $profileExperience->description:'')); ?></textarea>
