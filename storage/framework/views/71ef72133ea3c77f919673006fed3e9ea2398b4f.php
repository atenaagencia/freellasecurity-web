            ...
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        ...
                        <div class="actions"> <a href="<?php echo e(route('create.cms')); ?>" class="btn btn-xs btn-succes"><i class="glyphicon glyphicon-plus"></i> Add New C.M.S Page</a> </div>
                    </div>
...
<script>
    $(function () {
        var oTable = $('#cms_datatable_ajax').DataTable({
             ...
             */
            ajax: {
                url: '<?php echo route('fetch.data.cms'); ?>',
                data: function (d) {
                    d.id = $('#id').val();
    ...
    function delete_cms(id) {
        if (confirm('Are you sure! you want to delete? All content pages will be deleted too.')) {
            $.post("<?php echo e(route('delete.cms')); ?>", {id: id, _method: 'DELETE', _token: '<?php echo e(csrf_token()); ?>'})
