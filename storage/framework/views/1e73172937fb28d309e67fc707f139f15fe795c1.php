                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="container p-0">
                                            <?php echo e($user->printUserImage(200, 200)); ?>

                                            
                                        </div>
                                        <div class="jobinfo">
                                            <div class="companyName">
                                                <a href="" title="" class="badge badge-primary"><?php echo e($user->getName()); ?></a>
                                            </div>
                                            <div class="location">
                                                <label class="fulltime" title="">job_shift</label> - <span> <?php echo e($user->getLocation()); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        ...
                                        <a href="<?php echo e(route('applicant.profile', $job_application->id)); ?>" class="btn btn-primary">View Profile</a>
                                    </div>
                                    <div class="col-md-12">
