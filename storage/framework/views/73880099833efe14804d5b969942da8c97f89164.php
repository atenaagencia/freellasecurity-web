    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <a class="navbar-brand text-white js-scroll-trigger" href="<?php echo e(asset('/teste')); ?>"><img src="<?php echo e(asset('img/logos/logo_two.png')); ?>" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="<?php echo e(asset('/contact-us')); ?>">Contact</a></li>
