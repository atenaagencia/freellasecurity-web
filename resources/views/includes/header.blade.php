    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2 col-sm-3 col-xs-12">
                <a href="{{url('/')}}" class="logo" style="padding-top: 0.5rem !important">
                                ...
                                <li class="dropdown userbtn"><a
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="{{route('company.messages')}}"><i class="fa fa-envelope-o"
                                            ...
                                            <li><a href="{{ route('candidate.paymentdetails') }}"><i class="fa fa-cc-paypal"
                                                                                       aria-hidden="true"></i> {{__('payments')}}
                                            </a></li>
