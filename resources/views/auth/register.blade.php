                ...
                <div class="tab-content" id="pills-tabContent">
                    <div id="candidate" class="tab-pane fade show active" id="candidate" role="tabpanel" aria-labelledby="candidate-tab">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="container bg-transparent border-0 pb-0">
                                ...
                                <div class="py-2 formrow{{ $errors->has('first_name') ? ' has-error' : '' }}">
                                    <input id="first_name" type="text" class="form-control col-10 mx-auto" name="first_name" value="{{ old('first_name') }}" required autofocus placeholder="{{__('Primeito Nome')}}">
                                ...
                                <div class="py-2 formrow{{ $errors->has('middle_name') ? ' has-error' : '' }}">
                                    <input id="middle_name" type="text" class="form-control col-10 mx-auto" name="middle_name" value="{{ old('middle_name') }}" required autofocus placeholder="{{__('Nome do meio')}}">
                                ...
                                <div class="py-2 formrow{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                    <input id="last_name" type="text" class="form-control col-10 mx-auto" name="last_name" value="{{ old('last_name') }}" required autofocus placeholder="{{__('Último Nome')}}">
                                ...
                                <div class="py-2 formrow{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                    <input id="password_confirmation" type="password" class="form-control col-10 mx-auto" name="password_confirmation" value="" required placeholder="{{__('Confirmação de senha')}}">
                                ...
                                <div class="container pl-lg-5 pl-md-4 pl-sm-5 pl-xs-5 pt-0 pb-0 py-2 formrow{{ $errors->has('terms_of_use') ? ' has-error' : '' }}">
                                    ...
                                    <a href="{{url('cms/terms-of-use')}}" class="text-dark font-weight-bold">
                                        {{-- {{__('I accept Terms of Use')}} --}}
                                        {{__('Aceito o termo de uso')}}
                                    </a>
                        ...
                        <div class="container text-center pt-1 pb-4">
                            <div class="lead">{{__('Tem uma conta')}}? <a class="font-weight-bold text-primary" href="{{ route('login') }}">{{__(' Acesse aqui')}}</a></div>
                        </div>
