...
@section('title-page')
<h1 class="h3 py-4 font-weight-bold text-dark">{{__('Company Messages')}}</h1>
@endsection
        ...
        success: function(res) {
          ...
          if (res.from == from) {
            if (sender_logo == '') {
              ...
              html += '<img src="{{asset(' / company_logos / '.Auth::guard('
              company ')->user()->logo)}}" class="emp_img"><div class="can_name">' + sender_name + '</div>';
            }
          } else {
